...
describe('InfiniteLoader', function() {
  ...
  function getMarkup() {
    var _ref4 =
      ...
      isRowLoaded =
        _ref4$isRowLoaded === void 0 ? defaultIsRowLoaded : _ref4$isRowLoaded,
      _ref4$loadMoreRows = _ref4.loadMoreRows,
      loadMoreRows =
        _ref4$loadMoreRows === void 0
          ? defaultLoadMoreRows
          : _ref4$loadMoreRows,
      _ref4$minimumBatchSiz = _ref4.minimumBatchSize,
      minimumBatchSize =
        _ref4$minimumBatchSiz === void 0 ? 1 : _ref4$minimumBatchSiz,
    ...
    var TestComponent = /*#__PURE__*/ (function(_React$Component) {
      ...
      function TestComponent() {
        ...
        _this = _possibleConstructorReturn(
          this,
          (_getPrototypeOf2 = _getPrototypeOf(TestComponent)).call.apply(
            _getPrototypeOf2,
            [this].concat(args),
          ),
        );
    ...
    var TestComponent = /*#__PURE__*/ (function(_React$Component2) {
      ...
      function TestComponent() {
        ...
        _this2 = _possibleConstructorReturn(
          this,
          (_getPrototypeOf3 = _getPrototypeOf(TestComponent)).call.apply(
            _getPrototypeOf3,
            [this].concat(args),
          ),
        );
    ...
    var TestComponent = /*#__PURE__*/ (function(_React$Component3) {
      ...
      function TestComponent() {
        ...
        _this3 = _possibleConstructorReturn(
          this,
          (_getPrototypeOf4 = _getPrototypeOf(TestComponent)).call.apply(
            _getPrototypeOf4,
            [this].concat(args),
          ),
        );
