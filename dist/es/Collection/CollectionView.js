  ...
  function CollectionView() {
    ...
    _defineProperty(_assertThisInitialized(_this), '_onScroll', function(
      ...
      if (
        ...
        var scrollPositionChangeReason = event.cancelable
          ? SCROLL_POSITION_CHANGE_REASONS.OBSERVED
          : SCROLL_POSITION_CHANGE_REASONS.REQUESTED; // Synchronously set :isScrolling the first time (since _setNextState will reschedule its animation frame each time it's called)
      ...
      },
      {
        ...
        value: function render() {
          ...
          var horizontalScrollBarSize =
            totalWidth > width ? this._scrollbarSize : 0; // Also explicitly init styles to 'auto' if scrollbars are required.
