...
var CellMeasurerExample = /*#__PURE__*/ (function(_React$PureComponent) {
  ...
  function CellMeasurerExample(props, context) {
    ...
    _this = _possibleConstructorReturn(
      this,
      _getPrototypeOf(CellMeasurerExample).call(this, props, context),
    );
    _this.state = {
      currentTab: 0,
    };
            ...
            function(_ref) {
              ...
              return React.createElement(
                ...
                React.createElement(
                  'div',
                  null,
                  React.createElement('strong', null, 'Grid'),
                  ':',
                  React.createElement(
                    Tab,
                    _extends(
                  ...
                  React.createElement('strong', null, 'MultiGrid'),
                  ':',
                  React.createElement(
                    Tab,
                    _extends(
                  ...
                  React.createElement('strong', null, 'List'),
                  ':',
                  React.createElement(
                    Tab,
                    _extends(
...
function Tab(_ref4) {
  ...
  var classNames = clsx(
    styles.Tab,
    _defineProperty({}, styles.ActiveTab, currentTab === id),
  );
  return React.createElement(
    'button',
    {
