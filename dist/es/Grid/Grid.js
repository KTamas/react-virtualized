...
var renderNull =
  /*: NoContentRenderer*/
  function renderNull() /*: NoContentRenderer*/
  {
    return null;
  };
/*:: type ScrollPosition = {
  ...
  _createClass(
    ...
    [
      {
        ...
        value: function getOffsetForCell() {
          var _ref =
            ...
            alignment =
              _ref$alignment === void 0
                ? this.props.scrollToAlignment
                : _ref$alignment,
            _ref$columnIndex = _ref.columnIndex,
            columnIndex =
              _ref$columnIndex === void 0
                ? this.props.scrollToColumn
                : _ref$columnIndex,
            _ref$rowIndex = _ref.rowIndex,
            rowIndex =
              _ref$rowIndex === void 0 ? this.props.scrollToRow : _ref$rowIndex;
      ...
      },
      {
        ...
        value: function handleScrollEvent(_ref2) {
          var _ref2$scrollLeft = _ref2.scrollLeft,
            scrollLeftParam =
              _ref2$scrollLeft === void 0 ? 0 : _ref2$scrollLeft,
          ...
          if (
            ...
            var scrollDirectionHorizontal =
              scrollLeft !== this.state.scrollLeft
                ? scrollLeft > this.state.scrollLeft
                  ? SCROLL_DIRECTION_FORWARD
                  : SCROLL_DIRECTION_BACKWARD
                : this.state.scrollDirectionHorizontal;
            var scrollDirectionVertical =
        ...
        value: function recomputeGridSize() {
          ...
          this._recomputeScrollTopFlag =
            ...
            (this.state.scrollDirectionVertical === SCROLL_DIRECTION_FORWARD
              ...
              : rowIndex >= scrollToRow); // Clear cell cache in case we are scrolling;
      ...
      },
      {
        ...
        value: function componentDidUpdate(
          ...
          var columnOrRowCountJustIncreasedFromZero =
            ...
            (rowCount > 0 && prevProps.rowCount === 0); // Make sure requested changes to :scrollLeft or :scrollTop get applied.
          ...
          var sizeJustIncreasedFromZero =
            (prevProps.width === 0 || prevProps.height === 0) &&
            height > 0 &&
            width > 0; // Update scroll offsets if the current :scrollToColumn or :scrollToRow values requires it
      ...
      },
      {
        ...
        value: function _maybeCallOnScrollbarPresenceChange() {
          if (this._scrollbarPresenceChanged) {
            var onScrollbarPresenceChange = this.props
    ...
    [
      ...
      },
      {
        ...
        value: function _getEstimatedColumnSize(
          props,
          /*: Props*/
        ) {
      ...
      },
      {
        ...
        value: function _getEstimatedRowSize(
          props,
          /*: Props*/
        ) {
      ...
      },
      {
         ...
         */
        value: function _getScrollToPositionStateUpdate(
          _ref9,
        ) /*: $Shape<State>*/
        {
      ...
      {
        key: '_wrapSizeGetter',
        value: function _wrapSizeGetter(
          value,
          /*: CellSize*/
        ) /*: CellSizeGetter*/
        {
