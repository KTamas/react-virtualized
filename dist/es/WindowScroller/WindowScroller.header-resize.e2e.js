...
var renderWindowScroller = function renderWindowScroller(
    ...
    while (1) {
      switch ((_context2.prev = _context2.next)) {
        ...
        case 2:
          ...
          _context2.next = 7;
          return _regeneratorRuntime.awrap(
            page.exposeFunction('scrollFn', scrollFn),
          );

        case 7:
          _context2.next = 9;
          return _regeneratorRuntime.awrap(
            page.exposeFunction('resizeFn', resizeFn),
          );
        ...
        case 11:
          _context2.next = 13;
          return _regeneratorRuntime.awrap(
            page.evaluate(renderWindowScroller, true),
          );

        case 13:
          _context2.next = 15;
          return _regeneratorRuntime.awrap(
            page.$('[data-test-id="main-container"]'),
          );
    ...
    while (1) {
      switch ((_context3.prev = _context3.next)) {
        ...
        case 11:
          _context3.next = 13;
          return _regeneratorRuntime.awrap(
            page.evaluate(renderWindowScroller, false),
          );
