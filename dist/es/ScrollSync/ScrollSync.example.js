...
var GridExample = /*#__PURE__*/ (function(_React$PureComponent) {
  ...
  function GridExample(props, context) {
    ...
    _this = _possibleConstructorReturn(
      this,
      _getPrototypeOf(GridExample).call(this, props, context),
    );
    _this.state = {
      columnWidth: 75,
      columnCount: 50,
    ...
    _this._renderBodyCell = _this._renderBodyCell.bind(
      _assertThisInitialized(_this),
    );
    _this._renderHeaderCell = _this._renderHeaderCell.bind(
      _assertThisInitialized(_this),
    );
    _this._renderLeftSideCell = _this._renderLeftSideCell.bind(
      _assertThisInitialized(_this),
    );
    return _this;
  }
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            ' ',
            'configured to mimic a spreadsheet with a fixed header and first column. It also shows how a scroll callback can be used to control UI properties such as background color.',
          ),
          React.createElement(ScrollSync, null, function(_ref) {
            ...
            var leftBackgroundColor = mixColors(
              LEFT_COLOR_FROM,
              LEFT_COLOR_TO,
              y,
            );
            ...
            var topColor = '#ffffff';
            var middleBackgroundColor = mixColors(
              leftBackgroundColor,
              topBackgroundColor,
              0.5,
            );
              ...
              React.createElement(
                'div',
                {
                  ...
                  style: {
                    ...
                    color: leftColor,
                    backgroundColor: 'rgb('
                      .concat(topBackgroundColor.r, ',')
                      .concat(topBackgroundColor.g, ',')
                      .concat(topBackgroundColor.b, ')'),
                  },
                },
              ...
              React.createElement(
                'div',
                {
                  ...
                  style: {
                    ...
                    color: leftColor,
                    backgroundColor: 'rgb('
                      .concat(leftBackgroundColor.r, ',')
                      .concat(leftBackgroundColor.g, ',')
                      .concat(leftBackgroundColor.b, ')'),
                  },
                },
                React.createElement(Grid, {
                    ...
                    return React.createElement(
                      ...
                      React.createElement(
                        'div',
                        {
                          style: {
                            backgroundColor: 'rgb('
                              .concat(middleBackgroundColor.r, ',')
                              .concat(middleBackgroundColor.g, ',')
                              .concat(middleBackgroundColor.b, ')'),
                            color: middleColor,
                            height: height,
                            width: width,
                          },
