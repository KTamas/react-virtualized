...
var MultiGrid = /*#__PURE__*/ (function(_React$PureComponent) {
  ...
  function MultiGrid(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), '_onScrollLeft', function(
      scrollInfo,
    ) {
      var scrollLeft = scrollInfo.scrollLeft;
    ...
    _defineProperty(_assertThisInitialized(_this), '_onScrollTop', function(
      scrollInfo,
    ) {
    ...
    _defineProperty(_assertThisInitialized(_this), '_topLeftGridRef', function(
      ref,
    ) {
      _this._topLeftGrid = ref;
    });

    _defineProperty(_assertThisInitialized(_this), '_topRightGridRef', function(
      ref,
    ) {
    ...
    if (deferredMeasurementCache) {
      ...
      _this._deferredMeasurementCacheBottomRightGrid =
        _fixedColumnCount > 0 || _fixedRowCount > 0
          ? new CellMeasurerCacheDecorator({
              cellMeasurerCache: deferredMeasurementCache,
