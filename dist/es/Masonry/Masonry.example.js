  ...
  function GridExample(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), '_resetList', function() {
      ...
      list.forEach(function(datum) {
        datum.size =
          ROW_HEIGHTS[Math.floor(Math.random() * ROW_HEIGHTS.length)];
      });
    ...
    _this._renderAutoSizer = _this._renderAutoSizer.bind(
      _assertThisInitialized(_this),
    );
    _this._renderMasonry = _this._renderMasonry.bind(
      _assertThisInitialized(_this),
    );
    _this._setMasonryRef = _this._setMasonryRef.bind(
      _assertThisInitialized(_this),
    );
    return _this;
  }
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ContentBoxParagraph,
            null,
            'Optimized for masonry layouts. Cells are j.i.t. measured and layed out as a user scrolls. Sizes are cached so that resize/reflow is fast and does not require re-measuring.',
          ),
          React.createElement(
            ContentBoxParagraph,
            null,
            React.createElement(
              ...
              'Use ',
              React.createElement('code', null, 'WindowScroller'),
              '?',
            ),
            React.createElement(
              'label',
