...
var GridExample = /*#__PURE__*/ (function(_React$PureComponent) {
  ...
  function GridExample(props, context) {
    ...
    _this._getColumnWidth = _this._getColumnWidth.bind(
      _assertThisInitialized(_this),
    );
    _this._getRowClassName = _this._getRowClassName.bind(
      _assertThisInitialized(_this),
    );
    ...
    _this._onScrollToColumnChange = _this._onScrollToColumnChange.bind(
      _assertThisInitialized(_this),
    );
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ContentBoxParagraph,
            null,
            'Renders tabular data with virtualization along the vertical and horizontal axes. Row heights and column widths must be calculated ahead of time and specified as a fixed size or returned by a getter function.',
          ),
          React.createElement(
            ContentBoxParagraph,
            null,
            React.createElement(
              ...
              React.createElement('input', {
                ...
                onChange: function onChange(event) {
                  return _this2._updateUseDynamicRowHeights(
    ...
    },
    {
      ...
      value: function _renderBodyCell(_ref5) {
        ...
        var classNames = clsx(
          rowClass,
          styles.cell,
          _defineProperty({}, styles.centeredCell, columnIndex > 2),
        );
        return React.createElement(
          'div',
          {
