...
describe('Table', function() {
  ...
  function getMarkup() {
    var _ref4 =
      ...
      label = _ref4.label,
      flexTableProps = _objectWithoutProperties(_ref4, [
        'cellDataGetter',
        'cellRenderer',
        'columnData',
        'columnID',
  ...
  describe('children', function() {
    ...
    it('should accept subclasses of Column as children', function() {
      var AnotherColumn = /*#__PURE__*/ (function(_Column) {
        ...
        function AnotherColumn() {
          ...
          return _possibleConstructorReturn(
            this,
            _getPrototypeOf(AnotherColumn).apply(this, arguments),
          );
        }
      ...
      var children = [
        React.createElement(AnotherColumn, {
          dataKey: 'foo',
          width: 100,
        }),
      ];
  ...
  describe('initial rendering', function() {
    ...
    useImmutable.forEach(function(useImmutable) {
      ...
      it('should render the expected headers', function() {
        ...
        var columns = rendered.querySelectorAll(
      ...
      it('should render the expected rows and columns', function() {
        ...
        Array.from(rows).forEach(function(row, index) {
          ...
          var columns = row.querySelectorAll(
  ...
  describe('custom getter functions', function() {
        ...
        render(
          getMarkup({
            cellDataGetter: function cellDataGetter(_ref8) {
              ...
              return 'Custom '
                .concat(dataKey, ' for row ')
                .concat(rowData.get('id'));
            },
          }),
        ),
      );
      var nameColumns = rendered.querySelectorAll(
        '.ReactVirtualized__Table__rowColumn:first-of-type',
      );
      Array.from(nameColumns).forEach(function(nameColumn, index) {
        expect(nameColumn.textContent).toEqual(
          'Custom name for row '.concat(index),
        );
      });
    });
    it('should use a custom cellRenderer if specified', function() {
      ...
      Array.from(nameColumns).forEach(function(nameColumn, index) {
        var rowData = list.get(index);
        expect(nameColumn.textContent).toEqual(
          'Custom '.concat(rowData.get('name')),
        );
      });
    });
    it('should set the rendered cell content as the cell :title if it is a string', function() {
      ...
      var nameColumn = rendered.querySelector(
        '.ReactVirtualized__Table__rowColumn:first-of-type',
      );
  ...
  describe('sorting', function() {
    it('should not render sort indicators if no sort function is provided', function() {
      ...
      var nameColumn = rendered.querySelectorAll(
    ...
    it('should render the correct sort indicator by the current sort-by column', function() {
      ...
      sortDirections.forEach(function(sortDirection) {
        ...
        expect(
          nameColumn.querySelector(
            '.ReactVirtualized__Table__sortableHeaderIcon--'.concat(
              sortDirection,
            ),
          ),
        ).not.toEqual(null);
  ...
  describe('headerRowRenderer', function() {
    it('should render a custom header row if one is provided', function() {
      var headerRowRenderer = jest
        .fn()
        .mockReturnValue(React.createElement('div', null, 'foo bar'));
      var rendered = findDOMNode(
        render(
          getMarkup({
            headerHeight: 33,
  ...
  describe('onRowClick', function() {
    it('should call :onRowClick with the correct :rowIndex when a row is clicked', function() {
      ...
      expect(
        onRowClick.mock.calls.map(function(call) {
          return call[0].index;
        }),
      ).toEqual([0, 3]);
    });
  ...
  describe('onRowDoubleClick', function() {
    it('should call :onRowDoubleClick with the correct :rowIndex when a row is clicked', function() {
      ...
      expect(
        onRowDoubleClick.mock.calls.map(function(call) {
          return call[0].index;
        }),
      ).toEqual([0, 3]);
    });
  ...
  describe('onRowRightClick', function() {
    it('should call :onRowRightClick with the correct :rowIndex when a row is right-clicked', function() {
      ...
      expect(
        onRowRightClick.mock.calls.map(function(call) {
          return call[0].index;
        }),
      ).toEqual([0, 3]);
    });
  ...
  describe('onRowMouseOver/Out', function() {
    it('should call :onRowMouseOver and :onRowMouseOut with the correct :rowIndex when the mouse is moved over rows', function() {
      ...
      expect(
        onRowMouseOver.mock.calls.map(function(call) {
          return call[0].index;
        }),
      ).toEqual([1, 2, 3]);
      expect(
        onRowMouseOut.mock.calls.map(function(call) {
          return call[0].index;
        }),
      ).toEqual([0, 1, 2]);
    });
      ...
      render(
        getMarkup({
          onRowsRendered: function onRowsRendered(params) {
            ...
            return (
              (_params = params),
              (startIndex = _params.startIndex),
              (stopIndex = _params.stopIndex),
              _params
            );
          },
        }),
      ...
      render(
        getMarkup({
          ...
          onRowsRendered: function onRowsRendered(params) {
            ...
            return (
              (_params2 = params),
              (startIndex = _params2.startIndex),
              (stopIndex = _params2.stopIndex),
              _params2
            );
          },
        }),
      ...
      render(
        getMarkup({
          onRowsRendered: function onRowsRendered(params) {
            ...
            return (
              (_params3 = params),
              (startIndex = _params3.startIndex),
              (stopIndex = _params3.stopIndex),
              _params3
            );
          },
          scrollTop: 80,
      ...
      render(
        getMarkup({
          onRowsRendered: function onRowsRendered(params) {
            ...
            return (
              (_params4 = params),
              (startIndex = _params4.startIndex),
              (stopIndex = _params4.stopIndex),
              _params4
            );
          },
        }),
      ...
      render(
        getMarkup({
          onRowsRendered: function onRowsRendered(params) {
            ...
            return (
              (_params5 = params),
              (startIndex = _params5.startIndex),
              (stopIndex = _params5.stopIndex),
              _params5
            );
          },
          scrollTop: 80,
  ...
  describe('a11y properties', function() {
    ...
    it('should set aria colindex on a cell', function() {
      var rendered = findDOMNode(render(getMarkup()));
      var cells = rendered.querySelectorAll(
        '.ReactVirtualized__Table__rowColumn',
      );
    ...
    it('should set aria role on a header column', function() {
      var rendered = findDOMNode(render(getMarkup()));
      var header = rendered.querySelector(
        '.ReactVirtualized__Table__headerColumn',
      );
    ...
    it('should set aria-sort to "none" if the column is sortable but not the current sort', function() {
      ...
      var headers = rendered.querySelectorAll(
        '.ReactVirtualized__Table__headerColumn',
    ...
    it('should attach a11y properties to a header column if sort is enabled', function() {
      ...
      var row = rendered.querySelector(
        '.ReactVirtualized__Table__headerColumn',
      );
