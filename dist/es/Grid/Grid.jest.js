...
describe('Grid', function() {
      ...
      render(
        getMarkup({
          onSectionRendered: function onSectionRendered(params) {
            ...
            return (
              (_params = params),
              (columnStartIndex = _params.columnStartIndex),
              (columnStopIndex = _params.columnStopIndex),
              (rowStartIndex = _params.rowStartIndex),
              (rowStopIndex = _params.rowStopIndex),
              _params
            );
          },
        }),
        ...
        render(
          getMarkup({
            onSectionRendered: function onSectionRendered(params) {
              ...
              return (
                (_params2 = params),
                (columnStartIndex = _params2.columnStartIndex),
                (columnStopIndex = _params2.columnStopIndex),
                (rowStartIndex = _params2.rowStartIndex),
                (rowStopIndex = _params2.rowStopIndex),
                _params2
              );
            },
            scrollLeft: 250,
      ...
      render(
        getMarkup({
          onSectionRendered: function onSectionRendered(params) {
            ...
            return (
              (_params3 = params),
              (columnStartIndex = _params3.columnStartIndex),
              (columnStopIndex = _params3.columnStopIndex),
              (rowStartIndex = _params3.rowStartIndex),
              (rowStopIndex = _params3.rowStopIndex),
              _params3
            );
          },
        }),
      ...
      render(
        getMarkup({
          onSectionRendered: function onSectionRendered(params) {
            ...
            return (
              (_params4 = params),
              (columnStartIndex = _params4.columnStartIndex),
              (columnStopIndex = _params4.columnStopIndex),
              (rowStartIndex = _params4.rowStartIndex),
              (rowStopIndex = _params4.rowStopIndex),
              _params4
            );
          },
          scrollLeft: 250,
  ...
  describe('overscanColumnCount & overscanRowCount', function() {
    function createHelper() {
      var _columnOverscanStartIndex,
        _columnOverscanStopIndex,
        _columnStartIndex,
        _columnStopIndex,
        _rowOverscanStartIndex,
        _rowOverscanStopIndex,
        _rowStartIndex,
        _rowStopIndex;
    ...
    it('should set the correct scroll direction', function() {
      ...
      var grid = render(getMarkup()); // Simulate a scroll to set the initial internal state
        ...
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              _context.next = 7;
              return _regeneratorRuntime.awrap(onSectionRenderedPromise);
  ...
  describe('cell caching', function() {
        ...
        while (1) {
          switch ((_context4.prev = _context4.next)) {
            case 0:
              ...
              expect(cellRenderer.mock.calls[0][0].style).not.toBe(
                scrollingStyle,
              );
    ...
    it('should not trigger render by _debounceScrollEndedCallback if process slow table', function _callee5() {
      var scrollingResetTimeInterval,
      ...
      var GridComponent = /*#__PURE__*/ (function(_React$PureComponent) {
        ...
        function GridComponent() {
          ...
          return _possibleConstructorReturn(
            this,
            _getPrototypeOf(GridComponent).apply(this, arguments),
          );
        }
  ...
  describe('deferredMeasurementCache', function() {
    it('invalidateCellSizeAfterRender should invalidate cache and refresh displayed cells after mount', function() {
      ...
      render(getMarkup(props)); // 4 times for initial render + 4 once cellCache was cleared
